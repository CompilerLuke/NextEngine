...
enum class TextureFormat { UNORM, SRGB, HDR, U8, DEPTH };
...
inline TextureAspect operator|(TextureAspect a, TextureAspect b) { return (TextureAspect)((uint)a | (uint)b); }
inline void operator|=(TextureAspect& self, TextureAspect flag) { self = (TextureAspect)((uint)self | (uint)flag); }
inline bool operator&(TextureAspect a, TextureAspect b) {return (uint)a & (uint)b; }
