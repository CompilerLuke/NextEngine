...
ENGINE_API VertexBuffer alloc_vertex_buffer(VertexLayout layout, u64 vertices_length, void* vertices, u64
...
VertexBuffer alloc_vertex_buffer(VertexLayout layout, slice<T> vertices, slice<uint> indices) {
	return alloc_vertex_buffer(layout, vertices.length, (void*)vertices.data, indices.length, indices.data);
}
