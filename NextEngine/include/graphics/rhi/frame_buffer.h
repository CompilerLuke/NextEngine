...
struct AttachmentDesc {
	...
	TextureUsage usage = TextureUsage::Sampled | TextureUsage::InputAttachment;
...
ENGINE_API void add_dependency(FramebufferDesc& desc, Stage, RenderPass::ID, TextureAspect aspect);
...
ENGINE_API RenderPass::ID make_Framebuffer(FramebufferDesc&);
ENGINE_API RenderPass::ID make_Framebuffer(FramebufferDesc&, slice<SubpassDesc>);
