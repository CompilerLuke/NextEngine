...
void make_VertexStreaming(VertexStreaming& vertex_streaming, VkDevice device, VkPhysicalDevice physical_device, StagingQueue& queue, LayoutVertexInputs* layouts, u64* vertices_size_per_layout, u64* indices_size_per_layout);
