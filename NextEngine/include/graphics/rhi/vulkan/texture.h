...
#define MAX_IMAGE_UPLOAD mb(200)
#define MAX_IMAGE_DATA mb(500)
...
VkFormat to_vk_image_format(TextureFormat format, TextureAspect, uint num_channels);
VkFormat to_vk_image_format(const TextureDesc&);
VkImageAspectFlags to_vk_image_aspect_flags(TextureAspect);
