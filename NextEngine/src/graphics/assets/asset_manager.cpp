...
AssetManager::AssetManager(BufferAllocator& buffer_manager, Level& level) 
	: level(level), models(buffer_manager, level), shaders(level), textures(level), buffer_allocator(buffer_manager) {}
