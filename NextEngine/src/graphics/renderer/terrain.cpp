...
void init_terrain_render_resources(TerrainRenderResources& resources, const RenderSettings& settings) {
	...
	pipeline_desc.subpass = settings.zprepass ? 1 : 0;
...
const uint MAX_TERRAIN_TEXTURES = 1;
