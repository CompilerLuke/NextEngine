...
void make_RHI(const VulkanDesc& desc, Window& window) {
	...
	make_VertexStreaming(rhi.vertex_streaming, device, device, rhi.staging_queue, {rhi.vertex_layouts.vertex_layouts,
                                                                                   VERTEX_LAYOUT_COUNT},
                                                                                   vertex_max_memory,
                                                                                   index_max_memory, staging);
	...
	max_descriptor.max_samplers = 200;
	max_descriptor.max_ubos = 200;
	max_descriptor.max_sets = 200;
