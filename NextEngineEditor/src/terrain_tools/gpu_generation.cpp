...
void clear_terrain_render_pass(TerrainRenderResources& maps) {
	...
	transition_layout(clear_height.cmd_buffer, maps.displacement_map, TextureLayout::ColorAttachmentOptimal, TextureLayout::ShaderReadOptimal);
...
void gpu_estimate_terrain_surface(TerrainEditorResources& resources, TerrainRenderResources& maps, KrigingUBO& ubo) {
	...
	async_copy_image(cmd_buffer, maps.displacement_map, *resources.async_copy);
