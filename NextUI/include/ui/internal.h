...
struct UI {
    ...
    UIRenderer* renderer;
    LinearAllocator curr_allocator;
    LinearAllocator prev_allocator; // Double buffering

    tvector<UIView*> container_stack;
    UIView* prev_tree_root;
    hash_map<u64, UIView*, MAX_GUIDS> prev_container_by_id;
    hash_map<u64, UIView*, MAX_GUIDS> curr_container_by_id;
